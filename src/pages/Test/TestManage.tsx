...
//           {childCategories.filter((category: any) => newTestCategory === category.parentCategoryId).length !== 0 && (
...
//                 label="Category"
//               >
//                 {childCategories.filter((category: any) => newTestCategory === category.parentCategoryId).map((parentCategory: any) => (
//                   <MenuItem key={parentCategory.id} value={parentCategory.id}>
//                     {parentCategory.categoryName}
//                   </MenuItem>
//                 ))}
...
//     try {
//       const data = await getAllParentCategories();
//       if (data.code === 200 || data.code === 201) setParentCategories(data.data);
//       else console.error('Error fetching parent categories', data);
//     } catch (error) {
//       console.error('Error fetching parent categories', error);
//     }
//   };
...
//     try {
//       const data = await getTestByUser();
//       if (data.code === 200 || data.code === 201) setTests(data.data);
//       else console.error('Error fetching user test', data);
//     } catch (error) {
//       console.error('Error fetching user test', error);
//     }
//   };
...
//     try {
//       const data = await getAllChildCategories();
//       if (data.code === 200 || data.code === 201) setChildCategories(data.data);
//       else console.error('Error fetching child categories', data);
//     } catch (error) {
//       console.error('Error fetching child categories', error);
//     }
//   };
...
//   // Open/close modal for creating a new test
//   const handleModalOpen = () => setModalOpen(true);
//   const handleModalClose = () => setModalOpen(false);
...
//   useEffect(() => {
//     fetchAllParentCategories(); // Fetch parent categories on mount
//     fetchAllChildCategoryData(); // Fetch child categories on mount
//     fetchUserTest(); // Fetch user tests on mount
//   }, []);
