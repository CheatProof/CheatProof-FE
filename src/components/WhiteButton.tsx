const WhiteButton = ({
  ...
  return (
    <button
     ...
     disabled={disabled}
      className={`dark:bg-whiteSecondary bg-blackPrimary w-${width} mt-2 py-${py} text-${textSize} dark:hover:bg-white hover:bg-gray-800 bg-blackPrimary duration-200 flex items-center justify-center gap-x-2`}
    >
      {children}
