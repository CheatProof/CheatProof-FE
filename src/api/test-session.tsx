...
export const continueTest = async (testSession: any) => {
  try {
    const response = await fetch(`${baseUrl}/api/testSession/continue`,{
        method: 'POST',
        headers:{
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${localStorage.getItem("token")}` // replace YOUR_ACCESS_TOKEN with your actual access token
...
export const resumeTest = async (testSession: any) => {
  try {
    const response = await fetch(`${baseUrl}/api/testSession/resume`,{
        method: 'POST',
        headers:{
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${localStorage.getItem("token")}` // replace YOUR_ACCESS_TOKEN with your actual access token
